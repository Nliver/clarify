---
title: '渲染器架构'
description: 'Renderer 是 Clarify 的客户端运行时。它消费 @clarify-labs/cli 内部引擎生成的已处理内容（路由、MDX 组件、API 数据），并将其渲染为交互式文档站点。'
keywords: ['clarify', 'documentation', 'development', 'renderer']
---
