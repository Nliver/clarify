...
export function wrapper(arg0: WrapperProps) {
  ...
  return (
    <article className="clarify-mdx-page relative flex h-full min-w-0 flex-col pt-14 pb-10">
      <div className="clarify-page-actions mb-4 flex justify-end sm:absolute sm:top-14 sm:right-0 sm:mb-0">
        <PageActions />
      </div>
